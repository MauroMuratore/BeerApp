...
class CardBarBeerAdapter(
    val context: Context,
    val beerList: ArrayList<Beer>,
    val barBeers: List<BeerInBar>,
    private val imageRepository: ImageRepository = ImageRepository()
    ): RecyclerView.Adapter<RecyclerView.ViewHolder>()  {

    class CardBarBeerHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        val tvCost = itemView.findViewById<TextView>(R.id.tv_cost)
    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.card_bar_beer, parent, false)
        return CardBarBeerHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.tvCost.text = barBeers[position].price.toString()
